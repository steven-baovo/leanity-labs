...
function generateArticleCardHTML(article, index) {
    ...
    return `
        <article class="paper-card" data-id="${article._id}" data-slug="${article.slug?.current || ''}" data-category="${article.category || 'systems'}" style="cursor: pointer;">
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    document.addEventListener("click", function (e) {
        ...
        if (paperCard) {
            ...
            const slug = paperCard.getAttribute("data-slug");
